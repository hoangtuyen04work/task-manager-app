...
public class StatisticsController {
    ...
    @FXML
    private Label lblOverallCompleted;
    @FXML
    private Label lblOverallPending;
    @FXML
    private Label lblAverageRate;

    @FXML
    private Label lblHighTotal;
    @FXML
    private Label lblHighCompleted;
    @FXML
    private Label lblMediumTotal;
    @FXML
    private Label lblMediumCompleted;
    @FXML
    private Label lblLowTotal;
    @FXML
    private Label lblLowCompleted;
    ...
    @FXML
    private Label lblHeatmapDays;
    @FXML
    private Label lblHeatmapActiveDays;
    @FXML
    private Label lblHeatmapAverage;
    @FXML
    private Label lblHeatmapStreak;

    private TaskDAO taskDAO;
    private TaskStatistics statistics;
    private int heatmapMonths = 6;
    ...
    private void createHeatmapGrid(LocalDate startDate, LocalDate endDate,
        ...
        // Điều chỉnh startDate về đầu tuần
